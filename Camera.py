...
"}")
    ...
    def retranslateUi(self, Camera_Window):
        ...
        self.Close_pushButton.setText(_translate("Camera_Window", "Çıkış Yap"))
        ...
        self.label_Dok_No_2.setText(_translate("Camera_Window", "Kalite No"))
        ...
        self.Stop_pushButton.setText(_translate("Camera_Window", "Durdur"))
        self.Gezginler.setText(_translate("Camera_Window", "Ayarları İndir"))
