...
"}")
    ...
    def retranslateUi(self, Camera_Window):
        ...
        self.label_Dok_No.setText(_translate("Camera_Window", "DOK NO"))
        self.label_Dok_No_2.setText(_translate("Camera_Window", "KALİTE NO"))
