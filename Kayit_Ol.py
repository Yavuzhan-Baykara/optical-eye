...
"}")
        ...
        self.action_k = QtWidgets.QAction(Kayt_Ol)
        icon1 = QtGui.QIcon()
    ...
    def retranslateUi(self, Kayt_Ol):
        ...
        self.Giris_pushButton.setText(_translate("Kayt_Ol", "Kayıt Ol"))
        ...
        self.menu_k.setTitle(_translate("Kayt_Ol", "Çıkış"))
        self.action_k.setText(_translate("Kayt_Ol", "Çıkış"))
