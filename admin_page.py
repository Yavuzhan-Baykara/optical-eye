...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1675, 750)
        MainWindow.setMinimumSize(QtCore.QSize(1675, 750))
        MainWindow.setMaximumSize(QtCore.QSize(1675, 750))
...
"}")
        ...
        self.groupBox.setGeometry(QtCore.QRect(12, 12, 541, 650))
        self.groupBox.setMaximumSize(QtCore.QSize(541, 650))
        self.groupBox.setObjectName("groupBox")
        self.pushButton_Aktar_Kamera = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_Aktar_Kamera.setGeometry(QtCore.QRect(20, 560, 110, 40))
        ...
        self.lineEdit_Camera_Height.setGeometry(QtCore.QRect(290, 251, 241, 40))
        ...
        self.lineEdit_Camera_Width.setGeometry(QtCore.QRect(290, 310, 241, 40))
        ...
        self.lineEdit_Camera_Impact_Rate.setGeometry(QtCore.QRect(290, 370, 241, 40))
        ...
        self.lineEdit_Camera_Serial.setGeometry(QtCore.QRect(290, 191, 241, 40))
        ...
        self.lineEdit_CutOff.setGeometry(QtCore.QRect(290, 490, 241, 40))
        ...
        self.lineEdit_Camera_Exposure_Time.setGeometry(QtCore.QRect(290, 430, 241, 40))
        ...
        self.pushButton_Upload.setGeometry(QtCore.QRect(290, 560, 110, 40))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(570, 11, 571, 171))
        self.groupBox_2.setMaximumSize(QtCore.QSize(571, 200))
        ...
        self.pushButton_Aktar_Ysa.setGeometry(QtCore.QRect(20, 100, 110, 40))
        self.pushButton_Aktar_Ysa.setObjectName("pushButton_Aktar_Ysa")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(570, 191, 571, 271))
        self.groupBox_3.setMinimumSize(QtCore.QSize(571, 250))
        self.groupBox_3.setMaximumSize(QtCore.QSize(571, 341))
        ...
        self.pushButton_Aktar_Serial_Port.setGeometry(QtCore.QRect(20, 170, 110, 40))
        self.pushButton_Aktar_Serial_Port.setObjectName("pushButton_Aktar_Serial_Port")
        self.pushButton_Baglan = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_Baglan.setGeometry(QtCore.QRect(150, 170, 110, 40))
        self.pushButton_Baglan.setObjectName("pushButton_Baglan")
        self.pushButton_Kapat = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_Kapat.setGeometry(QtCore.QRect(280, 170, 110, 40))
        self.pushButton_Kapat.setObjectName("pushButton_Kapat")
        self.Kumas_ve_Isik_Ayari = QtWidgets.QGroupBox(self.centralwidget)
        self.Kumas_ve_Isik_Ayari.setGeometry(QtCore.QRect(570, 469, 571, 194))
        self.Kumas_ve_Isik_Ayari.setMinimumSize(QtCore.QSize(0, 0))
        self.Kumas_ve_Isik_Ayari.setMaximumSize(QtCore.QSize(571, 341))
        self.Kumas_ve_Isik_Ayari.setObjectName("Kumas_ve_Isik_Ayari")
        self.label_Kumas_Turu = QtWidgets.QLabel(self.Kumas_ve_Isik_Ayari)
        self.label_Kumas_Turu.setGeometry(QtCore.QRect(20, 30, 221, 40))
        self.label_Kumas_Turu.setObjectName("label_Kumas_Turu")
        self.label_Kumas_Turu_2 = QtWidgets.QLabel(self.Kumas_ve_Isik_Ayari)
        self.label_Kumas_Turu_2.setGeometry(QtCore.QRect(20, 80, 221, 40))
        self.label_Kumas_Turu_2.setObjectName("label_Kumas_Turu_2")
        self.horizontal_Isik_siddeti = QtWidgets.QScrollBar(self.Kumas_ve_Isik_Ayari)
        self.horizontal_Isik_siddeti.setGeometry(QtCore.QRect(250, 80, 241, 40))
        self.horizontal_Isik_siddeti.setMaximum(20)
        self.horizontal_Isik_siddeti.setOrientation(QtCore.Qt.Horizontal)
        self.horizontal_Isik_siddeti.setObjectName("horizontal_Isik_siddeti")
        self.lineEdit_Kumas_Turu = QtWidgets.QLineEdit(self.Kumas_ve_Isik_Ayari)
        self.lineEdit_Kumas_Turu.setGeometry(QtCore.QRect(267, 30, 206, 40))
        self.lineEdit_Kumas_Turu.setObjectName("lineEdit_Kumas_Turu")
        self.pushButton_Aktar_Kumas_Inf = QtWidgets.QPushButton(self.Kumas_ve_Isik_Ayari)
        self.pushButton_Aktar_Kumas_Inf.setGeometry(QtCore.QRect(20, 140, 110, 40))
        self.pushButton_Aktar_Kumas_Inf.setObjectName("pushButton_Aktar_Kumas_Inf")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(1160, 10, 491, 351))
        self.groupBox_4.setObjectName("groupBox_4")
        self.label_Kamera_Yuksekligi = QtWidgets.QLabel(self.groupBox_4)
        self.label_Kamera_Yuksekligi.setGeometry(QtCore.QRect(10, 50, 241, 40))
        self.label_Kamera_Yuksekligi.setObjectName("label_Kamera_Yuksekligi")
        self.lineEdit_Kamera_Yuksekligi = QtWidgets.QLineEdit(self.groupBox_4)
        self.lineEdit_Kamera_Yuksekligi.setGeometry(QtCore.QRect(270, 50, 206, 40))
        self.lineEdit_Kamera_Yuksekligi.setObjectName("lineEdit_Kamera_Yuksekligi")
        self.lineEdit_Kamera_Gorus_Genisligi = QtWidgets.QLineEdit(self.groupBox_4)
        self.lineEdit_Kamera_Gorus_Genisligi.setGeometry(QtCore.QRect(270, 110, 206, 40))
        self.lineEdit_Kamera_Gorus_Genisligi.setObjectName("lineEdit_Kamera_Gorus_Genisligi")
        self.label_Kamera_Gorus_Genisligi = QtWidgets.QLabel(self.groupBox_4)
        self.label_Kamera_Gorus_Genisligi.setGeometry(QtCore.QRect(10, 110, 241, 40))
        self.label_Kamera_Gorus_Genisligi.setObjectName("label_Kamera_Gorus_Genisligi")
        self.lineEdit_Kamera_Gorus_Yuksekligi = QtWidgets.QLineEdit(self.groupBox_4)
        self.lineEdit_Kamera_Gorus_Yuksekligi.setGeometry(QtCore.QRect(270, 170, 206, 40))
        self.lineEdit_Kamera_Gorus_Yuksekligi.setObjectName("lineEdit_Kamera_Gorus_Yuksekligi")
        self.label_Kamera_Gorus_Yuksekligi = QtWidgets.QLabel(self.groupBox_4)
        self.label_Kamera_Gorus_Yuksekligi.setGeometry(QtCore.QRect(10, 170, 241, 40))
        self.label_Kamera_Gorus_Yuksekligi.setObjectName("label_Kamera_Gorus_Yuksekligi")
        self.label_Kamera_Gorus_Acisi = QtWidgets.QLabel(self.groupBox_4)
        self.label_Kamera_Gorus_Acisi.setGeometry(QtCore.QRect(10, 230, 241, 40))
        self.label_Kamera_Gorus_Acisi.setObjectName("label_Kamera_Gorus_Acisi")
        self.lineEdit_Kamera_Gorus_Acisi = QtWidgets.QLineEdit(self.groupBox_4)
        self.lineEdit_Kamera_Gorus_Acisi.setGeometry(QtCore.QRect(270, 230, 206, 40))
        self.lineEdit_Kamera_Gorus_Acisi.setObjectName("lineEdit_Kamera_Gorus_Acisi")
        self.pushButton_Kamera_Konum_Ayari = QtWidgets.QPushButton(self.groupBox_4)
        self.pushButton_Kamera_Konum_Ayari.setGeometry(QtCore.QRect(10, 290, 110, 40))
        self.pushButton_Kamera_Konum_Ayari.setObjectName("pushButton_Kamera_Konum_Ayari")
        self.label_8 = QtWidgets.QLabel(self.groupBox_4)
        self.label_8.setGeometry(QtCore.QRect(146, 290, 331, 40))
        font = QtGui.QFont()
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(1160, 370, 491, 291))
        self.groupBox_5.setTitle("")
        self.groupBox_5.setObjectName("groupBox_5")
        self.mail_label = QtWidgets.QLabel(self.groupBox_5)
        self.mail_label.setGeometry(QtCore.QRect(10, 20, 241, 40))
        self.mail_label.setObjectName("mail_label")
        self.mail_listWidget = QtWidgets.QListWidget(self.groupBox_5)
        self.mail_listWidget.setGeometry(QtCore.QRect(10, 70, 241, 192))
        self.mail_listWidget.setObjectName("mail_listWidget")
        item = QtWidgets.QListWidgetItem()
        self.mail_listWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.mail_listWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.mail_listWidget.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.mail_listWidget.addItem(item)
        self.mail_label_2 = QtWidgets.QLabel(self.groupBox_5)
        self.mail_label_2.setGeometry(QtCore.QRect(270, 20, 211, 40))
        self.mail_label_2.setObjectName("mail_label_2")
        self.lineEdit_mail = QtWidgets.QLineEdit(self.groupBox_5)
        self.lineEdit_mail.setGeometry(QtCore.QRect(270, 70, 211, 40))
        self.lineEdit_mail.setText("")
        self.lineEdit_mail.setObjectName("lineEdit_mail")
        self.pushButton_mail_ekle = QtWidgets.QPushButton(self.groupBox_5)
        self.pushButton_mail_ekle.setGeometry(QtCore.QRect(270, 120, 91, 40))
        self.pushButton_mail_ekle.setObjectName("pushButton_mail_ekle")
        self.pushButton_mail_sil = QtWidgets.QPushButton(self.groupBox_5)
        self.pushButton_mail_sil.setGeometry(QtCore.QRect(390, 120, 91, 40))
        self.pushButton_mail_sil.setObjectName("pushButton_mail_sil")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1675, 43))
        self.menubar.setObjectName("menubar")
        self.menuKameralar = QtWidgets.QMenu(self.menubar)
        self.menuKameralar.setObjectName("menuKameralar")
        self.menuVeri_Tabani = QtWidgets.QMenu(self.menubar)
        self.menuVeri_Tabani.setObjectName("menuVeri_Tabani")
        self.menuHakknda = QtWidgets.QMenu(self.menubar)
        self.menuHakknda.setObjectName("menuHakknda")
        ...
        self.menu_k.setIcon(icon)
        self.menu_k.setObjectName("menu_k")
        MainWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(MainWindow)
        self.statusbar.setObjectName("statusbar")
        MainWindow.setStatusBar(self.statusbar)
        self.actionKameralar = QtWidgets.QAction(MainWindow)
        self.actionKameralar.setObjectName("actionKameralar")
        self.actionVeri_Taban = QtWidgets.QAction(MainWindow)
        ...
        self.menuVeri_Tabani.addAction(self.actionVeri_Taban)
        self.menuHakknda.addAction(self.actionHakk_nda)
        ...
        self.menubar.addAction(self.menuVeri_Tabani.menuAction())
        self.menubar.addAction(self.menuHakknda.menuAction())
        ...
        self.label_Kumas_Turu.setBuddy(self.lineEdit_Camera_Serial)
        self.label_Kumas_Turu_2.setBuddy(self.lineEdit_Camera_Serial)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_Baglan.setText(_translate("MainWindow", "Bağlan"))
        self.pushButton_Kapat.setText(_translate("MainWindow", "Kapat"))
        self.Kumas_ve_Isik_Ayari.setTitle(_translate("MainWindow", "Kumaş ve Işık Ayarı"))
        self.label_Kumas_Turu.setText(_translate("MainWindow", "Kumas Turu"))
        self.label_Kumas_Turu_2.setText(_translate("MainWindow", "Işık Şiddeti"))
        self.pushButton_Aktar_Kumas_Inf.setText(_translate("MainWindow", "Aktar"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Kamera Konum Ayarı"))
        self.label_Kamera_Yuksekligi.setText(_translate("MainWindow", "Kamera Yüksekliği"))
        self.label_Kamera_Gorus_Genisligi.setText(_translate("MainWindow", "Kamera Görüş Genişliği"))
        self.label_Kamera_Gorus_Yuksekligi.setText(_translate("MainWindow", "Kamera Görüş Yüksekliği"))
        self.label_Kamera_Gorus_Acisi.setText(_translate("MainWindow", "Kamera Görüş Açısı"))
        self.pushButton_Kamera_Konum_Ayari.setText(_translate("MainWindow", "Aktar"))
        self.label_8.setText(_translate("MainWindow", "*Konum ayarı bir kamera için seçiniz"))
        self.mail_label.setText(_translate("MainWindow", "Kayitli Mailler"))
        __sortingEnabled = self.mail_listWidget.isSortingEnabled()
        self.mail_listWidget.setSortingEnabled(False)
        item = self.mail_listWidget.item(0)
        item.setText(_translate("MainWindow", "menderes.merserize.118@gmail.com"))
        item = self.mail_listWidget.item(1)
        item.setText(_translate("MainWindow", "yavuzhan96@gmail.com"))
        item = self.mail_listWidget.item(2)
        item.setText(_translate("MainWindow", "deneme"))
        item = self.mail_listWidget.item(3)
        item.setText(_translate("MainWindow", "deneme"))
        item = self.mail_listWidget.item(4)
        item.setText(_translate("MainWindow", "deneme"))
        item = self.mail_listWidget.item(5)
        item.setText(_translate("MainWindow", "deneme"))
        item = self.mail_listWidget.item(6)
        item.setText(_translate("MainWindow", "deneme"))
        item = self.mail_listWidget.item(7)
        item.setText(_translate("MainWindow", "deneme"))
        item = self.mail_listWidget.item(8)
        item.setText(_translate("MainWindow", "deneme"))
        self.mail_listWidget.setSortingEnabled(__sortingEnabled)
        self.mail_label_2.setText(_translate("MainWindow", "E-posta"))
        self.pushButton_mail_ekle.setText(_translate("MainWindow", "Ekle"))
        self.pushButton_mail_sil.setText(_translate("MainWindow", "Sil"))
        self.menuKameralar.setTitle(_translate("MainWindow", "Kameralar"))
        self.menuVeri_Tabani.setTitle(_translate("MainWindow", "Veri Tabanı"))
        self.menuHakknda.setTitle(_translate("MainWindow", "Hakkında"))
        self.menu_k.setTitle(_translate("MainWindow", "Çıkış"))
        self.actionKameralar.setText(_translate("MainWindow", "Kameralar"))
        self.actionVeri_Taban.setText(_translate("MainWindow", "Veri Tabanı"))
