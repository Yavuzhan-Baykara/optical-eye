...
class Ui_Warning_window(object):
    def setupUi(self, Warning_window):
        ...
        Warning_window.resize(600, 250)
        Warning_window.setStyleSheet("/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QtWidgets.QWidget(Warning_window)
        self.centralwidget.setObjectName("centralwidget")
        self.warning_label = QtWidgets.QLabel(self.centralwidget)
        self.warning_label.setGeometry(QtCore.QRect(110, 30, 471, 80))
        self.warning_label.setWordWrap(True)
        self.warning_label.setObjectName("warning_label")
        self.Kapat_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.Kapat_pushButton.setGeometry(QtCore.QRect(235, 130, 130, 50))
        self.Kapat_pushButton.setStyleSheet("")
        self.Kapat_pushButton.setObjectName("Kapat_pushButton")
        self.warning_icon = QtWidgets.QLabel(self.centralwidget)
        self.warning_icon.setGeometry(QtCore.QRect(20, 30, 71, 80))
        ...
        Warning_window.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(Warning_window)
        self.statusbar.setObjectName("statusbar")
        Warning_window.setStatusBar(self.statusbar)
        self.menuBar = QtWidgets.QMenuBar(Warning_window)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 600, 43))
        self.menuBar.setObjectName("menuBar")
        Warning_window.setMenuBar(self.menuBar)
    ...
    def retranslateUi(self, Warning_window):
        ...
        Warning_window.setWindowTitle(_translate("Warning_window", "Warning_window"))
        self.warning_label.setText(_translate("Warning_window", "Dok No\'yu giriniz Lütfen. Kapatmak için butona tıklayınız lütfen..."))
        self.Kapat_pushButton.setText(_translate("Warning_window", "KAPAT"))
