...
def Cam_open(num):
    ...
    while (cam.isOpened()):
        ...
        frame=Detection(frame,net,frame_count,total_frames,colors,fps)
        ...
        while cameras.IsGrabbing():
            if secim=="3":
                ...
                if grabResult_3.GrabSucceeded():
                    ...
                    img_to_array_3=Detection(img_to_array_3,net,frame_count,total_frames,colors,fps)
...
def Detection(frame,net,frame_count,total_frames,colors,fps):
