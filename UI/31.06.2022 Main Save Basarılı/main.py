        ...
        while cameras.IsGrabbing():
            if secim=="3":
                ...
                if grabResult_3.GrabSucceeded():
                    ...
                    img_to_array_3=img_to_array_3[1500-zoom_value_3()*zoom_impact_rate:1800+zoom_value_4()*zoom_impact_rate, 1900-zoom_value_2()*zoom_impact_rate:2450+zoom_value_1()*zoom_impact_rate]
                  
                    
                    img_to_array_3=Detection(img_to_array_3,net,frame_count,total_frames,colors,fps,img_to_array_3_2,"Cam III")
                    
                    img_to_array_3=cv2.resize(img_to_array_3,(height-(zoom_value_6()*zoom_impact_rate)*4,width-(zoom_value_6()*zoom_impact_rate)*4))
                    height, width, channel=img_to_array_3.shape
                    step=channel*width
...
##Zoom 
def zoom_value_1():
    horizontal_value_1=ui2.horizontalSlider.value()
    if horizontal_value_1>=1:
        ui2.label_4.setText(str(horizontal_value_1*zoom_impact_rate))
    else:
        ui2.label_4.setText("Sag")
    return horizontal_value_1
def zoom_value_2():
    horizontal_value_2=ui2.horizontalSlider_2.value()
    if horizontal_value_2>=1:
        ui2.label_5.setText(str(horizontal_value_2*zoom_impact_rate))
    else:
        ui2.label_5.setText("Sol")
    return horizontal_value_2
...
def zoom_value_4():
    ...
    if horizontal_value_4>=1:
        ...
        ui2.label_13.setText("Asagı")
    return horizontal_value_4

def zoom_value_5():
    horizontal_value_5=ui2.horizontalSlider_5.value()
    if horizontal_value_5>=1:
        ui2.label_14.setText(str(horizontal_value_5*zoom_impact_rate))
    else:
        ui2.label_14.setText("Yakınlaştır")
    return horizontal_value_5

def zoom_value_6():
    horizontal_value_6=ui2.horizontalSlider_6.value()
    if horizontal_value_6>=1:
        ui2.label_16.setText(str(horizontal_value_6*zoom_impact_rate))
    else:
        ui2.label_16.setText("Uzaklaştır")
    return horizontal_value_6
...
#HorizontalSlider
ui2.horizontalSlider.valueChanged.connect(zoom_value_1)
ui2.horizontalSlider_2.valueChanged.connect(zoom_value_2)
ui2.horizontalSlider_3.valueChanged.connect(zoom_value_3)
ui2.horizontalSlider_4.valueChanged.connect(zoom_value_4)
ui2.horizontalSlider_5.valueChanged.connect(zoom_value_5)
ui2.horizontalSlider_6.valueChanged.connect(zoom_value_6)
