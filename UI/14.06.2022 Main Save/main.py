...
def Detection(frame,net,frame_count,total_frames,colors,fps,frame_origin,Cam):
    ...
    cv2.imwrite("./Database/"+str(day)+"."+str(month)+"."+str(year)+"/"+Cam+"/"+str(Ysa.class_list[classid])+"_"+str(day)+"."+str(month)+"."+str(year)+"."+str(hour)+"."+str(minute)+"."+str(sec)+".jpg",crop)
    now_DB=str(day)+"."+str(month)+"."+str(year)
    Path_DB="./Database/"+str(day)+"."+str(month)+"."+str(year)+"/"+Cam+"/"+str(Ysa.class_list[classid])+"_"+str(day)+"."+str(month)+"."+str(year)+"."+str(hour)+"."+str(minute)+"."+str(sec)+".jpg"
