...
def Cam_open(num):
    ...
    while (cam.isOpened()):
        ...
        frame=Detection(frame,net,frame_count,total_frames,colors,fps,frame2)
        ...
        while cameras.IsGrabbing():
            if secim=="3":
                ...
                if grabResult_3.GrabSucceeded():
                    ...
                    img_to_array_3=img_to_array_3[500:2500,1900:2500]
                    img_to_array_3_2=img_to_array_3
                    img_to_array_3=Detection(img_to_array_3,net,frame_count,total_frames,colors,fps,img_to_array_3_2)
...
def Detection(frame,net,frame_count,total_frames,colors,fps,frame_origin):
    ...
    cv2.imwrite(str(Ysa.class_list[classid])+".jpg",crop)
    cv2.waitKey(50)
    return frame
