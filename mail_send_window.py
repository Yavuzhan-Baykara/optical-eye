...
# Form implementation generated from reading ui file 'mail_send_window.ui'
#
...
class Ui_mail_send_window(object):
    def setupUi(self, mail_send_window):
        mail_send_window.setObjectName("mail_send_window")
        mail_send_window.resize(609, 518)
        mail_send_window.setStyleSheet("/* ---------------------------------------------------------------------------\n"
"\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QtWidgets.QWidget(mail_send_window)
        self.centralwidget.setObjectName("centralwidget")
        self.warning_label = QtWidgets.QLabel(self.centralwidget)
        self.warning_label.setGeometry(QtCore.QRect(105, 10, 471, 80))
        self.warning_label.setWordWrap(True)
        self.warning_label.setObjectName("warning_label")
        self.aktargnderlen_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.aktargnderlen_pushButton.setGeometry(QtCore.QRect(270, 240, 61, 50))
        self.aktargnderlen_pushButton.setStyleSheet("")
        self.aktargnderlen_pushButton.setObjectName("aktargnderlen_pushButton")
        self.warning_icon = QtWidgets.QLabel(self.centralwidget)
        self.warning_icon.setGeometry(QtCore.QRect(20, 10, 71, 80))
        self.warning_icon.setStyleSheet("image: url(:/Logos/Icon/MainWindow/warning.png);")
        self.warning_icon.setText("")
        self.warning_icon.setObjectName("warning_icon")
        self.mail_kayitli_adresler = QtWidgets.QListWidget(self.centralwidget)
        self.mail_kayitli_adresler.setGeometry(QtCore.QRect(20, 210, 241, 192))
        self.mail_kayitli_adresler.setObjectName("mail_kayitli_adresler")
        self.aktarkayitli_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.aktarkayitli_pushButton.setGeometry(QtCore.QRect(270, 310, 61, 50))
        self.aktarkayitli_pushButton.setStyleSheet("")
        self.aktarkayitli_pushButton.setObjectName("aktarkayitli_pushButton")
        self.mail_gnderilen_adresler = QtWidgets.QListWidget(self.centralwidget)
        self.mail_gnderilen_adresler.setGeometry(QtCore.QRect(340, 210, 241, 192))
        self.mail_gnderilen_adresler.setObjectName("mail_gnderilen_adresler")
        self.label_gnderici_adres = QtWidgets.QLabel(self.centralwidget)
        self.label_gnderici_adres.setGeometry(QtCore.QRect(20, 110, 241, 40))
        self.label_gnderici_adres.setObjectName("label_gnderici_adres")
        self.lineEdit_gnderici_adres = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_gnderici_adres.setGeometry(QtCore.QRect(340, 110, 241, 40))
        self.lineEdit_gnderici_adres.setObjectName("lineEdit_gnderici_adres")
        self.label_Kayitli_Mail_Adresleri = QtWidgets.QLabel(self.centralwidget)
        self.label_Kayitli_Mail_Adresleri.setGeometry(QtCore.QRect(20, 160, 241, 40))
        self.label_Kayitli_Mail_Adresleri.setObjectName("label_Kayitli_Mail_Adresleri")
        self.label_Gnderilen_Adresler = QtWidgets.QLabel(self.centralwidget)
        self.label_Gnderilen_Adresler.setGeometry(QtCore.QRect(340, 160, 241, 40))
        self.label_Gnderilen_Adresler.setObjectName("label_Gnderilen_Adresler")
        self.mailgonder_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.mailgonder_pushButton.setGeometry(QtCore.QRect(180, 420, 241, 50))
        self.mailgonder_pushButton.setStyleSheet("")
        self.mailgonder_pushButton.setObjectName("mailgonder_pushButton")
        mail_send_window.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(mail_send_window)
        self.statusbar.setObjectName("statusbar")
        mail_send_window.setStatusBar(self.statusbar)
        self.toolBar = QtWidgets.QToolBar(mail_send_window)
        self.toolBar.setObjectName("toolBar")
        mail_send_window.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBar)

        self.retranslateUi(mail_send_window)
        QtCore.QMetaObject.connectSlotsByName(mail_send_window)

    def retranslateUi(self, mail_send_window):
        _translate = QtCore.QCoreApplication.translate
        mail_send_window.setWindowTitle(_translate("mail_send_window", "Mail"))
        self.warning_label.setText(_translate("mail_send_window", "Lütfen pdf e-mail ile yollayacağınız kişileri atılacaklar listesine aktarın."))
        self.aktargnderlen_pushButton.setText(_translate("mail_send_window", ">"))
        self.aktarkayitli_pushButton.setText(_translate("mail_send_window", "<"))
        self.label_gnderici_adres.setText(_translate("mail_send_window", "Gönderici Adres"))
        self.label_Kayitli_Mail_Adresleri.setText(_translate("mail_send_window", "Kayıtlı Mail Adresleri"))
        self.label_Gnderilen_Adresler.setText(_translate("mail_send_window", "Gönderilen Adresler"))
        self.mailgonder_pushButton.setText(_translate("mail_send_window", "Gönder"))
        self.toolBar.setWindowTitle(_translate("mail_send_window", "toolBar"))
