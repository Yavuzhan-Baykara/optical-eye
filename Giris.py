...
class Ui_Giris_Window(object):
    def setupUi(self, Giris_Window):
        ...
        Giris_Window.resize(500, 800)
        Giris_Window.setMinimumSize(QtCore.QSize(500, 800))
        Giris_Window.setMaximumSize(QtCore.QSize(500, 800))
        Giris_Window.setStyleSheet("/* ---------------------------------------------------------------------------\n"
"\n"
...
"}")
        ...
        self.Kullaniciadi_lineEdit.setGeometry(QtCore.QRect(100, 230, 300, 50))
...
"}")
        ...
        self.Giris_pushButton.setGeometry(QtCore.QRect(100, 400, 141, 51))
...
"")
        ...
        self.Kayit_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.Kayit_pushButton.setGeometry(QtCore.QRect(260, 400, 131, 51))
        self.Kayit_pushButton.setStyleSheet("QPushButton{\n"
"\n"
"    border-radius: 20px;\n"
"\n"
"\n"
"}\n"
"")
        self.Kayit_pushButton.setObjectName("Kayit_pushButton")
        ...
        self.menuMenderes = QtWidgets.QMenu(self.menubar)
        self.menuMenderes.setStyleSheet("image: url(:/Logos/Icon/MainWindow/mmm.png);")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Icon/MainWindow/mmm.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuMenderes.setIcon(icon)
        self.menuMenderes.setObjectName("menuMenderes")
        Giris_Window.setMenuBar(self.menubar)
        self.actionClose = QtWidgets.QAction(Giris_Window)
        icon1 = QtGui.QIcon()
        ...
        self.menuMenderes.addAction(self.actionClose)
        self.menubar.addAction(self.menuMenderes.menuAction())

        self.retranslateUi(Giris_Window)
        QtCore.QMetaObject.connectSlotsByName(Giris_Window)
        Giris_Window.setTabOrder(self.Kullaniciadi_lineEdit, self.Sifre_lineEdit)
        Giris_Window.setTabOrder(self.Sifre_lineEdit, self.Giris_pushButton)
    ...
    def retranslateUi(self, Giris_Window):
        ...
        self.Kullaniciadi_lineEdit.setText(_translate("Giris_Window", "düzkasar132"))
        ...
        self.menuMenderes.setTitle(_translate("Giris_Window", "Menderes"))
        self.actionClose.setText(_translate("Giris_Window", "Çıkış"))
import source_rc
