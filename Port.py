...
class Ui_Port_Window(object):
    def setupUi(self, Port_Window):
        Port_Window.setObjectName("Port_Window")
        Port_Window.resize(440, 250)
        Port_Window.setMaximumSize(QtCore.QSize(440, 250))
        Port_Window.setStyleSheet("\n"
"* {\n"
"  padding: 0px;\n"
"  margin: 0px;\n"
"  border: 0px;\n"
...
"  padding: 0px;\n"
"}")
        self.centralwidget = QtWidgets.QWidget(Port_Window)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(10, 50, 421, 51))
        self.label.setObjectName("label")
        self.Ac_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.Ac_pushButton.setGeometry(QtCore.QRect(70, 150, 93, 31))
        self.Ac_pushButton.setObjectName("Ac_pushButton")
        self.Kapat_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.Kapat_pushButton.setGeometry(QtCore.QRect(280, 150, 93, 31))
        self.Kapat_pushButton.setObjectName("Kapat_pushButton")
        Port_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(Port_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 440, 43))
        self.menubar.setObjectName("menubar")
        Port_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(Port_Window)
        self.statusbar.setObjectName("statusbar")
        Port_Window.setStatusBar(self.statusbar)

        self.retranslateUi(Port_Window)
        QtCore.QMetaObject.connectSlotsByName(Port_Window)

    def retranslateUi(self, Port_Window):
        _translate = QtCore.QCoreApplication.translate
        Port_Window.setWindowTitle(_translate("Port_Window", "MainWindow"))
