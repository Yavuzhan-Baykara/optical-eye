...
from imutils import resize as resize_imutils
...
def Basler_Cameras():
    ...
    while 1:
        ...
        if len(frames) == 1:
            ...
            single_frame = resize_imutils(model_image,  width=1400)
            single_frame2  = resize_imutils(model_image, width=1400)
            new_frame_time = time()
        ...
        if len(frames) == 2:
            ...
            frame_1 = resize_imutils(frame, width=1400)
            frame_2 = resize_imutils(frame2, width=1400)
